...
/**
 * This class contains the configurations related to KongLocal Gateway
 */
@Component(
        name = "konglocal.external.gateway.configuration.component",
        immediate = true,
        service = GatewayAgentConfiguration.class
)
public class KongLocalGatewayConfiguration implements GatewayAgentConfiguration {
    private static final Log log = LogFactory.getLog(KongLocalAPIUtil.class);

    @Override
    public String getGatewayDeployerImplementation() {
        return KongLocalGatewayDeployer.class.getName();
    }
    ...
    public String getDiscoveryImplementation() {
        return KongLocalFederatedAPIDiscovery.class.getName();
    }
    ...
    public List<ConfigurationDto> getConnectionConfigurations() {
        ...
        configurationDtoList
            .add(new ConfigurationDto("admin_url", "Kong Admin URL", "input",
                "Kong Admin API URL (e.g., http://localhost:8001)",
                KongLocalConstants.KONGLOCAL_DEFAULT_ADMIN_URL, true, false,
                Collections.emptyList(), false));
        configurationDtoList
            .add(new ConfigurationDto("proxy_url", "Kong Proxy URL", "input",
                "Kong Proxy URL for API execution (e.g., http://kong:8000/)",
                KongLocalConstants.KONGLOCAL_DEFAULT_PROXY_URL, true, false,
                Collections.emptyList(), false));
    ...
    public String getType() {
        return KongLocalConstants.KONGLOCAL_TYPE;
    }

    @Override
    public GatewayPortalConfiguration getGatewayFeatureCatalog() throws APIManagementException {
        try (InputStream inputStream = KongLocalGatewayConfiguration.class.getClassLoader()
            ...
            JsonObject gatewayObject = jsonObject.getAsJsonObject(KongLocalConstants.KONGLOCAL_TYPE);
            ...
            config.setGatewayType(KongLocalConstants.KONGLOCAL_TYPE);
    ...
    public String getDefaultHostnameTemplate() {
        ...
        return KongLocalConstants.KONGLOCAL_API_EXECUTION_URL_TEMPLATE;
    }
}
